...
public class WheelOfFortuneRemoveTimeSegment() : WheelOfFortuneSegment
{
    public override WheelOfFortuneSegmentType SegmentType => WheelOfFortuneSegmentType.RemoveTime;
    ...
    internal WheelOfFortuneRemoveTimeSegment(WheelOfFortuneSegmentModel? segment) : this()
    {
